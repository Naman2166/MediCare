...
const About = () => {
  return (
    <div className='px-5'>
      ...
      <div className='text-center text-xl my-4 pt-9 pb-6'>
        <p>WHY <span className='text-gray-700 font-semibold'>CHOOSE US</span></p>
      </div>

      <div className='bg-gray-100 flex flex-col md:flex-row mb-20'>
        <div className='border-2 px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] transition-all duration-300 text-gray-600 cursor-pointer hover:bg-primary hover:text-white'>
          <b>Efficency:</b>
